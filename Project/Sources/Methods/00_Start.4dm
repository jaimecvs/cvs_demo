...
Case of 
	...
	: (Count parameters:C259=0)
		...
		If (Application version:C493<"1650")  // FROM V1650 THE POINT NOTATION IS ALLOWED
	...
	: (Count parameters:C259>=1)
		...
		$options.title:="get started with create, update, and delete actions in the dataStore?"
		
		$options.blog:="blog.4d.com"
		
		$options.info:="DataStore handling"
